...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        stick::drawState(st, frame, 0, mainFrame, Color{120, 200, 255, 255}, figH * 0.028f);
        ...
        stick::drawPose(pose::poseFor(st, frame, 0), mirror, Color{80, 90, 105, 180},
                        figH * 0.018f);
        ...
        std::snprintf(line, sizeof(line), "frame %d   %s   editing keyframe %s   %s", frame,
        ...
        const char *help = "[ ]  prev/next state       UP/DOWN  select field\n"
