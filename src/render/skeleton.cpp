...
constexpr Sequence kSequences[] = {
    {"stand -> walk -> stop", {ActionState::Idle, ActionState::Walk, ActionState::Idle}, 3},

    {"dash -> run -> brake",
     {ActionState::Idle, ActionState::Dash, ActionState::Run, ActionState::RunBrake,
      ActionState::Idle},
     5},

    // The dash-dance seam: dash, reverse through a turn, dash back.
    {"dash-dance",
     {ActionState::Dash, ActionState::Turn, ActionState::Dash, ActionState::Turn,
      ActionState::Dash},
     5},

    {"full jump and land",
     {ActionState::Idle, ActionState::Jumpsquat, ActionState::Airborne, ActionState::Landing,
      ActionState::Idle},
     5},
    ...
    {"wavedash",
     {ActionState::Jumpsquat, ActionState::Airborne, ActionState::AirDodge, ActionState::Landing,
      ActionState::Idle},
     5},

    {"aerial into landing",
     {ActionState::Airborne, ActionState::AttackAir, ActionState::Landing, ActionState::Idle},
     4},

    {"ground attack", {ActionState::Idle, ActionState::AttackGround, ActionState::Idle}, 3},
    ...
    {"hit -> knockdown -> get up",
     {ActionState::Hitstun, ActionState::Bounce, ActionState::DownWait, ActionState::GetUp,
      ActionState::Idle},
     5},

    {"hit -> tech", {ActionState::Hitstun, ActionState::Tech, ActionState::Idle}, 3},

    {"shield -> roll out",
     {ActionState::Idle, ActionState::ShieldOn, ActionState::Shield, ActionState::RollForward,
      ActionState::Idle},
     5},

    {"shield -> spotdodge",
     {ActionState::ShieldOn, ActionState::Shield, ActionState::SpotDodge, ActionState::Idle},
     4},

    {"shield hit -> break -> dizzy",
     {ActionState::Shield, ActionState::ShieldStun, ActionState::ShieldBroken, ActionState::Dizzy,
      ActionState::Idle},
     5},

    {"grab -> pummel -> throw",
     {ActionState::Grabbing, ActionState::GrabHold, ActionState::Pummel, ActionState::GrabHold,
      ActionState::Throwing, ActionState::Idle},
     6},

    {"grabbed -> escape", {ActionState::Grabbed, ActionState::GrabRelease, ActionState::Idle}, 3},

    {"thrown -> land",
     {ActionState::Thrown, ActionState::Hitstun, ActionState::Bounce, ActionState::DownWait,
      ActionState::GetUp},
     5},

    {"ledge -> climb",
     {ActionState::Airborne, ActionState::LedgeHang, ActionState::LedgeClimb, ActionState::Idle},
     4},

    {"ledge -> attack", {ActionState::LedgeHang, ActionState::LedgeAttack, ActionState::Idle}, 3},

    {"ledge -> jump away",
     {ActionState::LedgeHang, ActionState::LedgeJump, ActionState::Airborne, ActionState::Landing},
     4},

    {"airdodge -> helpless -> land",
     {ActionState::Airborne, ActionState::AirDodge, ActionState::FallHelpless, ActionState::Landing,
      ActionState::Idle},
     5},

    {"KO", {ActionState::Hitstun, ActionState::Dead}, 2},
};

constexpr int kSequenceCount = static_cast<int>(sizeof(kSequences) / sizeof(kSequences[0]));
